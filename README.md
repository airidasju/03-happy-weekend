...
-   FontAwesome icons
-   fixed width content (desktop only)t-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax)
...
1. Clone the repo
    ```sh
    git clone https://github.com/airidasju/03-happy-weekend.git
    ```
